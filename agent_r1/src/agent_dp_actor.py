...
from agent_r1.src.core_algos import agg_loss, compute_policy_loss, kl_penalty, compute_rank_grpo_advantage
...
class DataParallelPPOActor(BasePPOActor):
    ...
    def update_policy(self, data: DataProto):
        ...
        select_keys = ['responses', 'input_ids', 'attention_mask', 'position_ids', 'old_log_probs', 'advantages', 'action_mask', 'token_level_rewards']
        ...
        for epoch in range(self.config.ppo_epochs):
            for batch_idx, data in enumerate(dataloader):
                ...
                for data in micro_batches:
                    ...
                    advantages, returns = compute_rank_grpo_advantage(
