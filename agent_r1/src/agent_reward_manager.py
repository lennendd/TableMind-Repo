...
class AgentRewardManager:
    ...
    def __call__(self, data: DataProto, return_dict=False):
        ...
        for i in range(len(data)):
            ...
            extra_info['global_steps'] = data_item.meta_info.get('global_steps', 0)
            extra_info['turns'] = data_item.batch['turns'].item()
            extra_info['successes'] = data_item.batch['successes'].item()
